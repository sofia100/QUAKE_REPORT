...
public final class QueryUtils {
     ...
     */
    public static List<Quake> extractEarthquakesFromJson(String jsonResponse) {
...
*/
        ...
        for(int i=0;i<50;i++)
        {
            JSONObject equake = feature.getJSONObject(i);
            JSONObject prop = equake.getJSONObject("properties");
           double mag = prop.getDouble("mag");
            // double mag = Double.parseDouble(( prop.getDouble("magnitude")));
            String loc = prop.getString("place");
            long millisec = prop.getLong("time");
            String url = prop.getString("url");

            Quake q = new Quake(mag,loc,millisec,url);
           earthquakes.add(i,q);
        }
    ...
    public static List<Quake> fetchEarthquakeData(String requestUrl) {
        ...
        List<Quake> earthquakes = extractEarthquakesFromJson(jsonResponse);
